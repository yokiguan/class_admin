            ...
            <a-table :columns="columns"
                ...
                <div slot="kind" slot-scope="kind">
                    <a-select :default-value="kind">
                        <a-select-option :value="true"> 禁止相邻 </a-select-option>
                        <a-select-option :value="false"> 优先相邻 </a-select-option>
                    </a-select>
                </div>
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            //获取禁止相邻规则信息
            let {data}=await this.$api.schedule.arrangeClass.banGetting({planId:"940085b583944e19a0a098ca24804afc",htId:"14010510RBRSUU7",ruleType:"2"})
            console.log(data);
        ...
        methods: {
            ...
            Next(){
              this.$router.push(`/schedule/detail/sort_course/course?planId=${this.planId}`)
            },
            timesSetting(){
