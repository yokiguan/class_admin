...
const startChoose = {
    ...
    alterCourseSelect(params){
        return axios.post(`${schedulePlan}/saveCourseSelect.json`,params);
    },
    //开始选课查看（已测）(已调）
    getCourseSelect(params){
        return axios.get(`${schedulePlan}/getCourseSelect.json`,params);
    },
    ...
    //规则说明查看（已测）(已调）
    getTips(params){
        return axios.get(`${schedulePlan}/getTips.json`,{params});
    }
}
